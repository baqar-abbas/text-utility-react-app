...
> **[TEXT-UTILITY-APP]** Text Utils gives you a way to analyze your text quickly and efficiently. Be it word count, character count or Copy Text, Convert to upperCase and Lowercase. 
...
```sh
  cd my-folder
  git clone git@github.com:baqar-abbas/text-utility-react-app.git
```
<p align="right">(<a href="#readme-top">back to top</a>)</p>
